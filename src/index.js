...
//Jest testing capabilities were added to this template repo but the example project
//manipulates the dom which Jest can't handle. Project has been wrapped in an
//initializer function to not have it's top level code execute when jest tests import
//this file.
const initProject = ()=> {
